...
from tools.write_code import (
    WriteCodeTool,
)  # Assuming WriteCodeTool is in tools/write_code.py
...
"""
    ...
    result = await tool.write_code_to_file(
        code_description=code_description, project_path=project_path, filename=filename
    )
